...
- [Maintainability Guidelines](#Maintainability-Guidelines)
	...
	- [AV1520: Only use `var` when the type is obvious](#AV1520-Only-use-var-when-the-type-is-obvious)
	...
	- [AV1535: Always add a block after the keywords `if`, `else`, `do`, `while`, `for`, `foreach` and `case`](#AV1535-Always-add-a-block-after-the-keywords-if-else-do-while-for-foreach-and-case)
...
- [Naming Guidelines](#Naming-Guidelines)
	...
	- [AV1702: Use proper casing for language elements](#AV1702-Use-proper-casing-for-language-elements)
...
- [Layout Guidelines](#Layout-Guidelines)
	- [AV2400: Use a common layout](#AV2400-Use-a-common-layout)
	- [AV2402: Order namespaces in alphabetic order](#AV2402-Order-namespaces-in-alphabetic-order)
	- [AV2406: Place members in a well-defined order](#AV2406-Place-members-in-a-well-defined-order)
	- [AV2407: Be reluctant with `#region`](#AV2407-Be-reluctant-with-region)
...
## AV1520: Only use `var` when the type is obvious
...
## AV2402: Order namespaces in alphabetic order
...
- AV1230: Removed
- AV1520: Removed 'very'
- AV1535: 1. Added exception for `case` with `return`. 2. Added note for `using`.
- AV1702: All private fields are now Camel
- AV2201: static usage also uses alias
- AV2305: Only exposed calls
- AV2400: 1. Added exception for auto-property newlines. 2. Removed parentheses-guideline for all binary expressions.
- AV2402: Order all namespaces alphabetically, not System first.
- AV2406: 1. Removed `region` for privates. 2. Ordered the default Resharper way.
- AV2407: Be even more relucant, only use for automatic generated code?
